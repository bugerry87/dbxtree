...
MODEL='-d 2 -k 128 -C 4 -D 2 --branches uids pos pivots meta --activation softmax --loss focal_loss'
...
python gandm/train_nbit_tree.py $TRAIN $MODEL $LOG $PERM $TEST $TRANSFORM #$CHECKPOINT #$VAL #$PAYLOAD 
